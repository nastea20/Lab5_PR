...
bool exit = false;
while (!exit) //  se afișează un meniu și se așteaptă ca utilizatorul să selecteze o opțiune.
{
    //În funcție de opțiunea selectată, se apelează funcțiile corespunzătoare
    //pentru a lista e-mailurile POP3, IMAP, a descărca e-mailuri, a trimite e-mailuri etc
    Console.WriteLine("\nMenu:");
...
// se conectează la serverul POP3 și listează e-mailurile din cutia poștală utilizând comenzi POP3.
void ListEmailsPop3()
{
...
//se conectează la serverul IMAP și listează e-mailurile din cutia poștală utilizând librăria MailKit.
void ListEmailsImap()
{
...
void DownloadEmail()
{
    string downloadPath = "\\Users\\felicia\\Desktop\\";
